CREATE OR REPLACE FUNCTION tb_gis_garbagetruck_interpolate_2(
    target_colomn text,
    p1_x float,
    p1_y float,
    p2_x float,
...
query  = "SELECT * FROM tb_gis_mobile_stations_interpolate('t_nisshin_garbage_data', 'IDENTIFIER', 'datetime', 'location', 'COURSE SPEED " + target_colomn + "', "
