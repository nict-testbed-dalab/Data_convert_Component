CREATE OR REPLACE FUNCTION tb_gis_amedas_aggregate(
    target_colomn text,
    p1_x float,
    p1_y float,
    p2_x float,
...
query  = "SELECT * FROM tb_gis_fixed_stations_aggregate('t_amedas_code_data', 't_amedas_data', 'prefnumber', 'datetime', 'location', '" + target_colomn + "', "
