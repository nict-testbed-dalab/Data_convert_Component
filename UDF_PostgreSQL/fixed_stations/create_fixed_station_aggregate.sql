CREATE FUNCTION tb_gis_fixed_station_aggregate(station_table_name text, data_table_name text, target text, p1_x float, p1_y float, p2_x float, p2_y float, p3_x float, p3_y float, p4_x float, p4_y float, st timestamp, et timestamp, gr text, proc text) 
